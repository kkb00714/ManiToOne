...
|---|---|---|---|---|
|프론트 HTML, CSS, JS<br/>타임라인 조회<br/>마니또 편지 답장 CRUD<br/>편지, 답장 신고<br>마니또 매칭|관리자 페이지</br>및 유저 관리<br/></br>알림 서비스 (소켓)</br>Spring Security|유저 CRUD</br>OAuth2 ( Google )</br></br>회원 가입 및 </br>이메일 인증</br></br>로컬 로그인|프로필 페이지</br>(내 프로필, 타 유저)<br/></br>유저 팔로우<br/></br>게시물 목록, </br>좋아요 한 게시물 </br>목록 가져오기|게시물 CRUD</br>게시물 좋아요 기능</br>게시물 숨기기 기능</br>답글 CRUD</br>답글 신고</br>답글 숨기기|
